...
<h1 align="center">Привет, я Junior PHP Developer</h1>
...
## 📂 Проекты (добавь свои ссылки)
- 🚧 Проект 1 — кратко что делает и стек.
- 🚧 Проект 2 — кратко что делает и стек.
- 🚧 Проект 3 — кратко что делает и стек.
